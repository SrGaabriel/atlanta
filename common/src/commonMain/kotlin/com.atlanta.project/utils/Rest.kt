...
data class PermissionSet(override val bitMask: Int): BitmaskHolder<PermissionSet> {
    ...
    companion object Serializer: BitmaskSerializer<PermissionSet>({bitmask -> PermissionSet(bitmask)})
}
